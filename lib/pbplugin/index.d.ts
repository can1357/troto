...
export class CodeGeneratorRequest extends jspb.Message {
	...
	getProtoFileList(): Array<FileDescriptorProto>;
	setProtoFileList(value: Array<FileDescriptorProto>): void;
	addProtoFile(value?: FileDescriptorProto, index?: number): FileDescriptorProto;
...
export namespace CodeGeneratorRequest {
	export type AsObject = {
		...
		parameter?: string;
		protoFileList: Array<FileDescriptorProto.AsObject>;
...
export namespace CodeGeneratorResponse {
	...
	export class File extends jspb.Message {
		...
		getGeneratedCodeInfo(): GeneratedCodeInfo | undefined;
		setGeneratedCodeInfo(value?: GeneratedCodeInfo): void;
	...
	export namespace File {
		export type AsObject = {
			...
			content?: string;
			generatedCodeInfo?: GeneratedCodeInfo.AsObject;
		};
	}
