...
import * as google_protobuf_descriptor_pb from 'google-protobuf/google/protobuf/descriptor_pb.js';
	...
	proto.google.protobuf.compiler.CodeGeneratorRequest.toObject = function (includeInstance, msg) {
		var f,
			obj = {
				...
				protoFileList: jspb.Message.toObjectList(
					msg.getProtoFileList(),
...
proto.google.protobuf.compiler.CodeGeneratorRequest.serializeBinaryToWriter = function (message, writer) {
	...
	if (f.length > 0) {
		writer.writeRepeatedMessage(15, f, google_protobuf_descriptor_pb.FileDescriptorProto.serializeBinaryToWriter);
	}
	f = message.getCompilerVersion();
	if (f != null) {
		writer.writeMessage(3, f, proto.google.protobuf.compiler.Version.serializeBinaryToWriter);
	}
};
		...
		var f,
			obj = {
				...
				fileList: jspb.Message.toObjectList(
					msg.getFileList(),
					proto.google.protobuf.compiler.CodeGeneratorResponse.File.toObject,
					includeInstance
				)
			};
...
proto.google.protobuf.compiler.CodeGeneratorResponse.serializeBinaryToWriter = function (message, writer) {
	...
	if (f.length > 0) {
		writer.writeRepeatedMessage(15, f, proto.google.protobuf.compiler.CodeGeneratorResponse.File.serializeBinaryToWriter);
	}
};
	...
	proto.google.protobuf.compiler.CodeGeneratorResponse.File.toObject = function (includeInstance, msg) {
		var f,
			obj = {
				...
				generatedCodeInfo:
					(f = msg.getGeneratedCodeInfo()) && google_protobuf_descriptor_pb.GeneratedCodeInfo.toObject(includeInstance, f)
			};
...
proto.google.protobuf.compiler.CodeGeneratorResponse.File.serializeBinaryToWriter = function (message, writer) {
	...
	if (f != null) {
		writer.writeMessage(16, f, google_protobuf_descriptor_pb.GeneratedCodeInfo.serializeBinaryToWriter);
	}
};
